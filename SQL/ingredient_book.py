...
location = '/Users/ijeong-an/Desktop/codestates/cp1/team_data/ingredient_book.csv'
...
df.to_sql('ingredient_book', schema='cp1', con = engine, if_exists='replace', index=False)